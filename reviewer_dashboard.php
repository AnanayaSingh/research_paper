<?php
    ...
    $sql="SELECT R.review_id,P.paper_id,P.paper_title,P.paper_topic,P.abstract,P.keywords,P.paper_file,R.recommendation,R.comment,R.review_result,R.status FROM review AS R JOIN paper AS P ON R.paper_id=P.paper_id AND R.user_id='$user_id'";
