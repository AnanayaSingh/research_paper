<?php
    ...
    {
        $sql="INSERT INTO `user`(`name`,`username`,`password`,`instution`,`research_area`,`email`,`address`,`phone_number`) VALUES('$name','$username','$password','$institution','$research_area','$email','$address','$phone')";
        echo $sql;
